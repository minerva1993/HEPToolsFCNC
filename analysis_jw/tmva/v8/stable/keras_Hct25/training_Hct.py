...
loader = TMVA.DataLoader("keras_Hct25")
...
loader.PrepareTrainingAndTestTree(
    sigCut, bkgCut,
    "nTrain_Signal=15000:nTrain_Background=370000:SplitMode=Random:NormMode=NumEvents:!V"
)

factory.BookMethod(loader, TMVA.Types.kBDT, "BDT", "!H:!V:NTrees=250:MinNodeSize=10%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=15")
...
factory.BookMethod(loader, TMVA.Types.kPyKeras, 'Keras_TF',"H:!V:VarTransform=G,D,P:FilenameModel=model_Hct.h5:NumEpochs=50:BatchSize=1000")
