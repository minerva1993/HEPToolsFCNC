...
loader = TMVA.DataLoader("keras_Hut30")
...
factory.BookMethod(loader, TMVA.Types.kBDT, "BDT", "!H:!V:NTrees=250:MinNodeSize=10%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20")
...
factory.BookMethod(loader, TMVA.Types.kPyKeras, 'Keras_TF',"H:!V:VarTransform=G,D,P:FilenameModel=model_Hut.h5:NumEpochs=30:BatchSize=1000")
