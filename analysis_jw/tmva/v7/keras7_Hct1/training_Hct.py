...
loader = TMVA.DataLoader("keras7_Hct1")
...
model.compile(loss='binary_crossentropy', optimizer=Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=7E-4), metrics=['binary_accuracy'])
